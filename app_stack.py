...
def get_as():
        ...
        'email_cert':{'template_stack':'list_cal',
                'filename':'calibration', 
                'path':'.',
                'command':'email_cert' , 
                'security':False,
        ...
        'list_services':{
                'template_stack':'list_open_services', 
                'filename':'service_logs', 
                'path':'.', 
        ...
        'list_van_inventory':{
                'template_stack':'van_inventory', 
                'filename':'service_logs', 
                'path':'.', 
                'command':'list_van_inventory',
                'security':False,
                'content_type': 'text/html',
                'server_cache_on':True,
                'server_cache_age':30,
